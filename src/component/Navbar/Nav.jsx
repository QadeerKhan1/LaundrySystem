...
export default function Navbar() {
  ...
  <div className="container-fluid  " id='navMain'>
    <a className="navbar-brand" ><img src={logo} alt="" style={{width:'120px',height:'100px' }} /></a>
    ...
    <div className="collapse navbar-collapse allitem" id="navbarNav">
      <ul className="navbar-nav mx-auto" >
        ...
        <li className="nav-item">
          <a className='nav-link'  id='orderbtn' className="btn btn-danger font-weight-bold btn-pill" ><Link style={{color:"black"}}  to="/signup">Order</Link></a>
        </li>
      </ul>
    </div>
  </div>
